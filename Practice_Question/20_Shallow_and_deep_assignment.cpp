...
// Problem Statement 2:
// Implement a shallow copy constructor for a class that represents a playlist.
// The Playlist class contains an array of songs which has a name and a
// duration. Test your implementation by creating two instances of the Playlist
// class and using the copy constructor to create a shallow copy of one of them.
...
//   void set_song(int i, const Songs &song) { songs[i] = song; }
...
//   void print() {
//     for (int i = 0; i < 5; i++) {
//       cout << "Song " << i + 1 << ": " << songs[i].get_name()
//            << ", Duration: " << songs[i].get_duration() << endl;
//     }
//   }
// };
...
// public:
//     Event() : id(nullptr), name(""), starting_date(""), ending_date("") {}
...
//     string get_s() const { return starting_date; }
//     string get_e() const { return ending_date; }
// };
...
//             cout << "Id : " << event[i].get_id() << endl;
//             cout << "Name: " << event[i].get_name() << endl;
//             cout << "Starting date: " << event[i].get_s() << endl;
//             cout << "Ending date: " << event[i].get_e() << endl;
//             cout << "---------------------------" << endl;
//         }
//     }
// };
...
//     cal.set_event(1, Event(13, "College function", "1-04-24", "3-04-24"));
//     cal.set_event(2, Event(14, "University function", "5-04-24", "6-04-24"));
//     cal.set_event(3, Event(15, "Marriage function", "3-04-24", "4-04-24"));
//     cal.set_event(4, Event(132, "Birthday function", "3-04-24", "6-04-24"));
